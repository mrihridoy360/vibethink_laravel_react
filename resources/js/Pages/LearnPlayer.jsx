    ...
    return (
        <div className="min-h-screen flex bg-[#f4f7fe] text-gray-800 font-sans antialiased">
            ...
            <div className={`flex-grow flex flex-col min-w-0 transition-all duration-300 ${sidebarCollapsed ? 'lg:pl-20' : 'lg:pl-64'}`}>
                ...
                {/* Topbar */}
                <header className="h-16 bg-white/80 backdrop-blur-md border-b border-gray-100 px-6 lg:px-8 flex items-center justify-between shrink-0 sticky top-0 z-40">
                    <div className="flex items-center gap-4">
                        <h2 className="text-xl font-bold text-gray-800">ইনরোল্ড কোর্স</h2>
                    </div>
                                    ...
                                    return (
                                        <div key={chapter.id} className="border border-gray-200 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                                            ...
                                            <button
                                                ...
                                                className={`w-full px-4 py-3 flex items-center justify-between text-left transition-colors cursor-pointer bg-white ${
                                                    ...
                                                    {chapterLessons.map((lesson, lessonIndex) => {
                                                        ...
                                                        return (
                                                            <button
                                                                ...
                                                                className={`w-full flex items-center justify-between gap-3 p-2.5 rounded-lg text-left transition-all cursor-pointer ${
                                                                    isSelected
                                    ...
                                    <div className="bg-white rounded-xl shadow-md border border-gray-200 flex flex-col">
                                        ...
                                        <div className="sticky bottom-0 z-10 border-t border-gray-200 bg-white/95 p-4 backdrop-blur-sm flex items-center justify-center gap-4 sm:rounded-b-xl">
                                            <button
                                                ...
                                                className={`h-9 px-4 rounded-lg text-sm font-semibold flex items-center gap-2 border transition-all cursor-pointer ${
                                                    prevLesson
                                            ...
                                            <button
                                                ...
                                                className={`h-9 px-4 rounded-lg text-sm font-semibold flex items-center gap-2 transition-all cursor-pointer ${
                                                    nextLesson
