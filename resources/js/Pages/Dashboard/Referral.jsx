    ...
    return (
        <div className="space-y-6">
            ...
            <div>
                ...
                <p className="text-sm text-gray-400 mt-0.5">বন্ধুদের রেফার করুন এবং কমিশন আয় করুন!</p>
            </div>
                ...
                <div className={`flex items-center gap-3 p-4 rounded-xl border ${
                    ...
                    <div>
                        ...
                        {referralUser.rejection_reason && (
                            <p className="text-[11px] text-red-600 mt-0.5">{referralUser.rejection_reason}</p>
                        )}
                    </div>
                </div>
            )}
            ...
            {referralCode ? (
                <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-6 text-white relative overflow-hidden">
                    ...
                    <div className="relative">
                        <div className="flex items-center gap-2 mb-1">
                            ...
                            <p className="text-sm text-blue-200 font-medium">আপনার রেফারেল কোড</p>
                        </div>
                        <div className="flex items-center gap-3 mt-2">
                            ...
                            <button
                                onClick={handleCopy}
                                className="flex items-center gap-1.5 bg-white text-blue-700 text-sm font-bold px-3 py-2 rounded-xl hover:bg-blue-50 transition-colors shadow-md"
                            >
                ...
                <div className="bg-gradient-to-br from-gray-100 to-gray-50 border border-gray-200 rounded-2xl p-6 text-center">
                    ...
                    <p className="text-sm text-gray-400 mt-1">অ্যাডমিনের সাথে যোগাযোগ করুন।</p>
                </div>
            )}
            ...
            <div className="grid grid-cols-3 gap-4">
                <div className="bg-white rounded-2xl border border-gray-100 p-4 text-center">
                    ...
                    <p className="text-[11px] text-gray-400">রেফার করা</p>
                </div>
                <div className="bg-white rounded-2xl border border-gray-100 p-4 text-center">
                    ...
                    <p className="text-[11px] text-gray-400">মোট আয়</p>
                </div>
                <div className="bg-white rounded-2xl border border-gray-100 p-4 text-center">
                    ...
                    <p className="text-[11px] text-gray-400">অপেক্ষমাণ</p>
                </div>
            </div>
            ...
            {commissions.length > 0 && (
                <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
                    <div className="px-5 py-3 border-b border-gray-50 flex items-center gap-2">
                        ...
                        <h3 className="text-sm font-bold text-gray-800 uppercase tracking-wider">কমিশন ইতিহাস</h3>
                    </div>
                    <div className="divide-y divide-gray-50">
                        {commissions.map(commission => (
                            <div key={commission.id} className="flex items-center gap-4 px-5 py-3 hover:bg-gray-50 transition-colors">
                                <div className="flex-grow min-w-0">
                                    <p className="text-sm font-semibold text-gray-900">{commission.referred?.name}</p>
                                    <p className="text-[11px] text-gray-400 truncate">{commission.course?.title}</p>
                                    <p className="text-[11px] text-gray-300">{new Date(commission.created_at).toLocaleDateString('bn-BD')}</p>
                                </div>
                                <div className="text-right shrink-0">
                                    <p className="text-sm font-extrabold text-green-600">+৳{parseFloat(commission.commission_amount).toFixed(2)}</p>
                                    <p className="text-[10px] text-gray-400">{commission.commission_percentage}% কমিশন</p>
            ...
            {referredUsers.length > 0 && (
                <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
                    <div className="px-5 py-3 border-b border-gray-50 flex items-center gap-2">
                        ...
                        <h3 className="text-sm font-bold text-gray-800 uppercase tracking-wider">রেফার করা সদস্যরা</h3>
                    </div>
                    <div className="divide-y divide-gray-50">
                        {referredUsers.map(u => (
                            <div key={u.id} className="flex items-center gap-3 px-5 py-3">
                                <div className="h-8 w-8 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center text-sm font-bold shrink-0">
